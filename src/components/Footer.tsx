            ...
            {isAdminMode ? (
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={onResetData}
                  className="px-2.5 py-1.5 rounded-xl text-rose-400 hover:text-rose-300 hover:bg-rose-950/40 border border-rose-500/30 transition text-[11px] cursor-pointer"
                  title="整理券データをすべて消去"
                >
                  データ全消去
                </button>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-white bg-slate-800 hover:bg-slate-700 border border-cyan-500/30 transition cursor-pointer"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-cyan-300 hover:text-white bg-slate-900/90 hover:bg-slate-800 border border-cyan-500/40 hover:border-cyan-400/80 transition cursor-pointer shadow-sm"
                title="運営関係者（2年K組スタッフ）専用画面への移行"
              >
                <ShieldCheck className="w-3.5 h-3.5 text-cyan-400" />
                <span>司令室（運営スタッフ管理）</span>
              </button>
            )}
          </div>
        </div>
